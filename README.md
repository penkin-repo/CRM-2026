...
> 📖 **Гайд по стилям оформления 1С для ИИ / Разработчиков**:  
> Полное руководство по цветовой палитре, верстке и компонентам 1С:Предприятие находится в файле [`STYLEGUIDE_1C.md`](file:///c:/DEV/2026/CRM%202026/STYLEGUIDE_1C.md). Используйте его для сохранения стилистического единообразия UI.
